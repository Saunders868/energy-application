"use client";
import { Button, Check, Container, Heading, Saveenergy, Section } from '@/components'
import cx from 'clsx'
import Link from 'next/link';
import { useState } from 'react'

const PricingPage = () => {
    const [recommeded, setRecommended] = useState<boolean>(true);
  return (
    <Section classname='bg-white'>
        <Container>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 my-12 sm:my-24 gap-8">
                <div className={cx("px-8 col-span-2 shadow-xl md:col-span-1 relative overflow-hidden pb-8 pt-14 rounded-3xl", recommeded === false ? "border-none bg-secondary-950 text-white" : "border-t-4 border-primary-300")}>
                    {
                        recommeded == false && (
                    ...
                    <Button variant={recommeded == false ? 'tertiary-reversed' : 'tertiary'} className='w-full mt-8 py-4'>
                ...
                <div className={cx("px-8 col-span-2 shadow-xl md:col-span-1 relative overflow-hidden pb-8 pt-14 rounded-3xl", recommeded === true ? "border-none bg-secondary-950 text-white" : "border-t-4 border-primary-300")}>
                    {
                        recommeded == true && (
                            <p className="absolute top-0 bg-primary-300 text-black text-center py-2 w-full right-0">
                                Recommended
                    ...
                    <Button variant={recommeded == true ? 'tertiary-reversed' : 'tertiary'} className='w-full mt-8 py-4'>
                        <Link href="/">Get Started</Link>
                    </Button>
                    <div>
                        <Heading as='h4' className='my-4'>
            ...
            <div className="p-20 shadow-xl bg-primary-300 rounded-3xl flex md:flex-row items-center flex-col gap-4">
                <div>
                    <Saveenergy />
                </div>
                <div>
